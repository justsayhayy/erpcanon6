      ...
      <li class="nav-item">
        ...
        <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('admin/account'); ?>">
              <i class="fas fa-project-diagram fa-sm fa-fw"></i>&nbsp;Chart of Account
            </a>
            <a class="collapse-item" href="<?= base_url('admin/jurnalumum'); ?>">
              <i class="fas fa-book fa-sm fa-fw"></i>&nbsp;Jurnal Umum
            </a>
            <a class="collapse-item" href="<?= base_url('admin/neraca'); ?>">
              <i class="fas fa-fw fa-balance-scale"></i>&nbsp;Neraca Lajur
            </a>
            <a class="collapse-item" href="<?= base_url('admin/bukubesar'); ?>">
              <i class="fas fa-book-open fa-sm fa-fw"></i>&nbsp;Buku Besar
            </a>
            <a class="collapse-item" href="<?= base_url('admin/manager'); ?>">
              <i class="fas fa-fw fa-user-cog"></i>&nbsp;Manager P&L
            </a>
            <a class="collapse-item" href="<?= base_url('admin/asst_manager'); ?>">
              <i class="fas fa-user-secret fa-sm fa-fw"></i>&nbsp;Assistant Manager
            </a>
            <a class="collapse-item" href="<?= base_url('admin/win2manager'); ?>">
              <i class="fas fa-fw fa-user-tie"></i>&nbsp;Win Win Manager
            </a>
            <!-- -->
            <a class="collapse-item" href="<?= base_url('admin/deposit'); ?>">
