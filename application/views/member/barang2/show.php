 ...
 <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="">
                    <?php echo $curfmt->formatCurrency($erp['hpp'], "IDR"); ?>
                </td>
                <td class="">
                    <?php echo $curfmt->formatCurrency($erp['sebelumpajak'], "IDR"); ?>
                </td>
                <td class="">
                    <?php echo $erp['ppn']."%"; ?>
                </td>
                <td class="">
                    <?php echo $curfmt->formatCurrency($erp['setelahpajak'], "IDR"); ?>
                </td>
                <td class="">
                    <?php echo $curfmt->formatCurrency($erp['hargasetoran'], "IDR"); ?>
                </td>
                <td class="">
                    <?php echo $curfmt->formatCurrency($erp['jumlah'], "IDR"); ?>
                </td>
                <td>
