            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <table id="lookup" class="table-responsive table table-hover" cellspacing="2" width="" style="font-size: small;">
                        ...
                        <!-- <table id="lookup" class="table table-responsive table-hover table-striped"> -->
                            <thead>
                                <tr>
                                 <th>Kode Barang</th>
                                <th>Nama Barang</th>
...
<div class="row mt-3">
        ...
        <div class="col-lg-4">
            <form action="<?php echo base_url('barang/index_serach');?>" method="post">
                <div class="d-flex">
                <div class="input-group input-group-sm">
                    <!-- <div class="input-group-prepend">
       ...
       <?php 
        ...
        <div class="modal fade" id="modal_edit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
          <div class="modal-dialog">
            ...
            <form role="form" method="post" action="<?php echo base_url().'barang/edit/'.$id; ?>">
              <div class="box-body">
                <div class="form-row">
                <div class="form-group col-md-6">
                <label for="inputKode">Kode</label>
