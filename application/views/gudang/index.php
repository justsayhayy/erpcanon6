...
<div class="row mt-3">
        <div class="col-lg-8 mb-2">
                ...
                <input type="submit" name="search_submit" value="Cari">
                    ...
                    <!-- <form action="" method="post">
                        <div class="input-group">
                        <input type="text" name="keyword" id="keyword" placeholder="Cari Data Jurusan..." class="form-control">
                        <div class="input-group-append">
                            <button type="submit" class="btn btn-primary">Cari</button>
                        </div>
                        </div>
                ...
                <!-- <form action="" method="post">
                <div class="input-group">
                <input type="text" name="keyword" id="" placeholder="Cari Data Gudang..." class="form-control">
                <div class="input-group-append">
                    <button type="submit" class="btn btn-primary">Cari</button>
                </div>
                </div>
                ...
                <!-- <div class="input-group input-group-sm mt-1">
                    <div class="input-group-prepend">
                    <label for="security" class="input-group-text">Search :</label> -->
                    <!-- </div>
...
<!-- <a href="<?= base_url('');?>" class="btn btn-info mb-2">Koreksi</a> -->
