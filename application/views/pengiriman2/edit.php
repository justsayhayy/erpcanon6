...
<form action="<?= base_url('pengiriman2/edit/').$pengiriman['id']; ?>" method="post">
...
<div class="row mt-3">
        <div class="col-lg-4">
                ...
                <div class="input-group input-group-sm">
                    <div class="input-group-prepend">
					 ...
					 <input type="hidden" id="kode_id" name="kode_id" value="<?= $pengiriman['kode_id']; ?>">
        ...
        <div class="col-lg-6">
                ...
                <div class="input-group-prepend">
                    ...
                    <input type="text" name="no_do" id="no_do" value="<?= $pengiriman['no_do']; ?>" class="form-control form-control-sm">
                </div>
                <div class="input-group input-group-sm mt-1">
                <div class="input-group-prepend">
...
<table class="table table-bordered" width="100%" cellspacing="0">
        ...
        <thead>
            ...
            <tr>
                ...
                <td style="text-align:center;">
                   <input type="text" class="form-control" value="<?= $pengiriman['kode'];?>" id="kode" name="kode" data-toggle="modal" data-target="#myModal1" required>
                </td>
                <td>
				...
				<td>
                  <input type="text" class="form-control" id="gudang" value="<?= $pengiriman['gudang_asal'];?>" name="gudang_asal" readonly>
                </td>
				<td style="text-align:center;">
                     <input type="text" class="form-control" id="gudang1" value="<?= $pengiriman['gudang_tujuan'];?>" name="gudang_tujuan" readonly>
                </td>
    ...
    <table class="table table-bordered" width="100%" cellspacing="0">
        ...
        <thead>
		 ...
		 <tr>
                <td style="text-align:center;">
                    <input type="text" class="form-control" id="qty_karton" name="qty_karton" value="<?= $pengiriman['qty_karton']?>" required>
                </td>
                <td style="text-align:center;">
                    <input type="text" class="form-control" id="qty_karton_rsk" name="qty_karton_rsk" value="<?= $pengiriman['qty_karton_rusak']?>" required>
                </td>
                <td style="text-align:center;">
                   <input type="text" class="form-control" id="qty_perkarton" name="qty_perkarton" value="<?= $pengiriman['qty_perkarton']?>" required>
                </td>
                <td style="text-align:center;">
                   <input type="text" class="form-control" id="qty_perkarton_rsk" name="qty_perkarton_rsk" value="<?= $pengiriman['qty_perkarton_rusak']?>" required>
                </td>
                <td style="text-align:center;">
                     <input type="text" class="form-control" id="total" name="total" value="<?= $pengiriman['total']?>" required>
                </td>
                <td style="text-align:center;">
                     <input type="text" class="form-control" id="total_rsk" name="total_rsk" value="<?= $pengiriman['total_rusak']?>" required>
                </td>
                
                <td style="text-align:center;">
                     <input type="text" class="form-control" id="qty" name="stok" value="<?= $stok['unitbagus']; ?>" readonly>
                </td>
                <td style="text-align:center;">
                     <input type="text" class="form-control" id="qty_rsk" name="stok_rsk" value="<?= $stok['unitrusak']; ?>" readonly>
                </td>
            </tr>
    </table>
...
<br>
 ...
 <a href="<?= base_url('pengiriman2');?>" class="btn btn-success">Kembali</a>
 </form>
